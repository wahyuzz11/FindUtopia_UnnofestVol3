...
<body>
    ...
    $perpage = 8;
    $totalData = $itemLost->queryOrderNoLimit()->num_rows;
    ...
    $result = $itemLost->queryOrderWithLimit($startPage, $perpage);
    ...
    echo "<th scope='col' class='text-center'>Owner</th>";
    echo "<th scope='col' class='text-center'>Verification</th>";
    echo "</tr>";
    echo "</thead>";
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<td class='text-center'><button type='button' class='btn btn-info btn-sm btn-change' onclick='location.href=\"verifikasi.php?id=$id\"'>Verification</button></td>";
        echo "</tr>";
    }
    echo "</table>";
