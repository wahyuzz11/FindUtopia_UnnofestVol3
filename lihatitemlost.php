...
<body>
  ...
  <div class="container-fluid">
    ...
    <h1 class="h1 mb-3 text-center">Lost Item Details</h1>
    <div class="container col-xxl-8 px-4 py-5">
      ...
      $result = $itemLost->querySingleItem($id);
      ...
      if ($row = $result->fetch_assoc()) {
        ...
        echo "<img src='lost_images/" . $imageId . "." . $imageExt . "' class='d-block mx-lg-auto img-fluid' alt='Bootstrap Themes' width='700'";
        echo "height='500' loading='lazy'>";
        echo "</div>";
        echo "<div class='col-lg-6'>";
        echo "<h1 class='display-1 fw-bold lh-1 mb-3'>" . $row['name'] . "</h1>";
        echo "<h2 class='display-6 lh-1 mb-3'> Owner : " . $row['user'] . "</h2>";
